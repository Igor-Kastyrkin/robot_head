...
void Adafruit_PWMServoDriver::setPWMFreq(float freq) {
    ...
    uart.print("Attempting to set freq ");
    uart.println(freq);
#endif
...
#ifdef ENABLE_DEBUG_OUTPUT
    uart.print("Estimated pre-scale: "); uart.println(prescaleval);
#endif

    uint8_t prescale = floor(prescaleval + 0.5);
#ifdef ENABLE_DEBUG_OUTPUT
    uart.print("Final pre-scale: "); uart.println(prescale);
#endif
...
#ifdef ENABLE_DEBUG_OUTPUT
    uart.print("Mode now 0x"); uart.println(read8(PCA9685_MODE1), HEX);
#endif
}
...
#ifdef ENABLE_DEBUG_OUTPUT
    uart.print("Setting PWM "); uart.print(num); uart.print(": "); uart.print(on); uart.print("->"); uart.println(off);
#endif
